...
photo:
  - 'https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/restful.gif'
tags:
  - Spring MVC
  - Restful API
categories:
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/17748187.jpg)
...
4. 运行两个测试方法
   ...
   - getUserTest()
     ...
     ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/1494678.jpg)

   - getUsernameTest()

     ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/47141981.jpg)
...
2. 使用Validator
   ...
   - 在实体类中加入相关注解
     ...
     ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/85052773.jpg)
   ...
   - 运行
     ...
     ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/6534844.jpg)
   ...
   - 自定义异常消息
     ...
     ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/54703293.jpg)

   - 再次测试

     ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/71167951.jpg)
...
1. 访问不存在的Restful API
   ...
   - 浏览器访问
     ...
     ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/75771661.jpg)

   - Rest api client访问

     > 这里使用的是postman访问，一个比较好用的rest client客户端，当然也可以使用其他的，工具而已。

     ![1546962718119](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/1546962718119.png)
...
- 在项目的resources目录中新增文件夹`static.error`
  ...
  ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/11460459.jpg)
...
- 重启并使用浏览器访问，跳转的页面为自定义的页面，文件命名为返回的错误状态码
  ...
  ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/28263142.jpg)
...
5. 启动测试
   ...
   - 测试
     ...
     ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/75470881.jpg)
