...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/Figure-1-Mapping-Table-to-Collection-1.png)
...
1. 选择`MongoDB`版本和操作系统版本，我这里是安装到`CentOS 7`上。
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190616212311.png)

2. 下载完毕后将下载的`.tgz`的包上传到服务器。

   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/1560692109626.png)
...
6. 查看是否成功启动
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/1560692613635.png)
...
8. 再次查看
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190616220302.png)
...
5. 查看是否成功启动
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190616231210.png)
...
6. 配置通配IP访问
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190616231600.png)
...
7. 重新启动
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190616231736.png)
...
1. 搜索`MongoDB`镜像
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190616232951.png)
