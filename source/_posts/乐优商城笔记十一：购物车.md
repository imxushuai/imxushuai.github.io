...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/1527585343248.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/1527737419294.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/1527587496457.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/1533739711101.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/1533739810927.png)

示例：

![1533739929733](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/1533739929733.png)
...
- 添加购物车需要知道购物的数量，所以我们需要获取数量大小。我们在Vue中定义num，保存数量
  ...
  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530213140.png)
...
- 将num与页面的input框绑定，同时给`+`和`-`的按钮绑定事件
  ...
  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530213328.png)
...
- 为`加入购物车`按钮添加单击事件
  ...
  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530213900.png)
...
- 在`common.js`中加入`verifyUser()`方法
  ...
  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530220038.png)

- 测试

![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530215903.png)
...
- 查看Vue实例中的购物车数据
  ...
  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530220618.png)

### 渲染购物车数据

在页面中展示carts的数据

![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530230056.png)

## 修改数量

- 给页面的 `+` 和 `-`绑定点击事件，修改num 的值

  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530222102.png)
...
- 在Vue中定义变量，记录被选中的购物车项
  ...
  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530223051.png)

- 将`selected`与页面的选择框绑定，值为当前购物车项

  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530223200.png)

### 初始化全部选中

- 修改`loadCarts`方法

  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530223358.png)
...
- 页面调用计算总价
  ...
  ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530223641.png)

## 效果

![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190530230207.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190603173413.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190603211732.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190603211943.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190603214729.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190603214932.png)
...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190603220502.png)
