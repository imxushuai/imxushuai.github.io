...
![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/Jenkins.png)
...
1. 下载`RPM`包
   ...
   ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190628234509.png)
...
5. 启动
   ...
   ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190630200749.png)

6. 访问`http://ip:port/8080`

   ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190630200939.png)
...
4. 访问测试
   ...
   ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190629002927.png)
...
1. 获取管理员密码
   ...
   - 方式1：查看挂载到本地目录的密码文件
     ...
     ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190629003259.png)
...
2. 将获取到的密码输入到密码框中，点击`Continue`，然后选择安装插件，选择左侧安装默认插件即可。
   ...
   ![](https://imxushuai-01.coding.net/p/pic/d/pic/git/raw/master/20190629003528.png)
