...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/springdatajpa.jpg)
...
- 准备数据库，我这里使用同一个`Mysql`中的两个不同的数据库，并且分别在两个数据库中创建了一张数据表
  ...
  ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190823153409.png)

- primary_table表结构

  ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190823153506.png)

- secondary_table表结构

  ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190823153608.png)
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190823154821.png)
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190823155714.png)
