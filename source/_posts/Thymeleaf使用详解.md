...
![1526435213659](https://images.xushuai.fun/1526435213659.png)



![1526435267302](https://images.xushuai.fun/1526435267302.png)

勾选web和Thymeleaf的依赖：

![1526435317440](https://images.xushuai.fun/1526435317440.png)

项目结构：

 ![1526435434999](https://images.xushuai.fun/1526435434999.png)
...
不需要做任何配置，启动器已经帮我们把Thymeleaf的视图器配置完成：
 ...
 ![1526435647041](https://images.xushuai.fun/1526435647041.png)

而且，还配置了模板文件（html）的位置，与jsp类似的前缀+ 视图名 + 后缀风格：

 ![1526435706301](https://images.xushuai.fun/1526435706301.png)
...
启动项目，访问页面：
 ...
 ![1526436248528](https://images.xushuai.fun/1526436248528.png)
...
效果：
 ...
 ![1526438010948](https://images.xushuai.fun/1526438010948.png)
...
现在，我们不经过SpringMVC，而是直接用浏览器打开页面看看：
 ...
 ![1526438337869](https://images.xushuai.fun/1526438337869.png)
...
```
 ...
 ![1526440538848](https://images.xushuai.fun/1526440538848.png)
...
- 字符串字面值
  ...
  `th:text`中的thymeleaf并不会被认为是变量，而是一个字符串
   ...
   ![1526958538157](https://images.xushuai.fun/1526958538157.png)
...
- 数字字面值
  ...
  ```
   ...
   ![1526958856078](https://images.xushuai.fun/1526958856078.png)
...
与上面是完全等效的，这样就省去了字符串字面值的书写。
 ...
 ![1526959781368](https://images.xushuai.fun/1526959781368.png)
...
- 算术运算
  ...
  ```
   ...
   ![1526959990356](https://images.xushuai.fun/1526959990356.png)
...
- 条件运算
  ...
  其中的每一个部分都可以是Thymeleaf中的任意表达式。
   ...
   ![1526960230778](https://images.xushuai.fun/1526960230778.png)
  ...
  注意：`?:`之间没有空格。
   ...
   ![1526960384564](https://images.xushuai.fun/1526960384564.png)
...
其它情况包括null都被认定为false
 ...
 ![1526960499522](https://images.xushuai.fun/1526960499522.png)
...
另外`th:case="*"`表示默认，放最后。
 ...
 ![1526960621714](https://images.xushuai.fun/1526960621714.png)

页面：

 ![1526961251878](https://images.xushuai.fun/1526961251878.png)
...
![1526961583904](https://images.xushuai.fun/1526961583904.png)
...
控制台：
 ...
 ![1526961525185](https://images.xushuai.fun/1526961525185.png)
