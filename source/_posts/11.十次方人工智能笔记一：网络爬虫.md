...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/webmagic_framework.jpg)
...
2. 向数据库`tensquare_article`中的`tb_channel`表中添加记录
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190705190146.png)
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190710213941.png)

## 用户数据

**用户数据**

![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190710214037.png)

**用户头像**

![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190710212819.png)