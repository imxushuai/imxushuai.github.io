...
3. 输入名称，扩容，选择刚刚创建的服务，输入数量。
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190702104239.png)

4. 复制触发地址，使用`POST`请求访问该地址。（每执行一次，增加步长值相等数量的容器，直到容器数量达到最大数量）

   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190702103927.png)

5. 查看是否扩容成功

   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190702104413.png)
...
3. 查看web ui
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190702113412.png)
...
3. 访问：`http://192.168.136.104:3001`
   ...
   ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/20190702130500.png)
