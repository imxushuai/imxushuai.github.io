...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/学成在线-分布式事务示意图1.jpg)

另外一种分布式事务的表现是，一个应用程序使用了多个数据源连接了不同的数据库，当一次事务需要操作多个数据源，此时也属于分布式事务，当系统作了数据库拆分后会出现此种情况。

![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/学成在线-分布式事务示意图2.jpg)
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/学成在线-CAP示意图.jpg)
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/学成在线-分布式事务-2PC.jpg)
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/学成在线-分布式事务-2PC示例.jpg)
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/学成在线-分布式事务-TCC示例.jpg)
...
![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/学成在线-分布式事务-消息队列示例.jpg)
...
- 尚硅谷：谷粒商城
  ...
  ![](https://imxushuai-blog.oss-cn-chengdu.aliyuncs.com/QQ%E6%88%AA%E5%9B%BE20200701155804.png)
